...
def train_model(kae_model, data_loader, num_epochs):
    ...
    for epoch in epoch_progress:
        ...
        epoch_progress.set_description(f"Loss(total): {total_loss_mean:.4f}, Loss(recon): {reconstruction_loss_mean:.4f}, Loss(pred): {prediction_loss_mean:.4f}, Loss(lin): {linearity_loss_mean:.6f}")

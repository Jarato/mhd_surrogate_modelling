# mhd_surrogate_core/src/mhd_surrogate_core/plotting/evaluation.py

"""
Functions for plotting model evaluation metrics, such as R² scores,
rollout errors, and latent space dynamics.
"""
...
# Note: The helper functions are now in 'processed.py' as they are used there.
# We will import them if needed, but these functions are self-contained.

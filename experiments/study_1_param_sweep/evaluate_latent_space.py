...
def main():
    ...
    with torch.no_grad():
        ...
        try:
            ...
            true_projected_traj = (W_inv @ true_latent_trajectory.T).T
            pred_projected_traj = (W_inv @ predicted_latent_trajectory.T).T
        except torch.linalg.LinAlgError:
            true_projected_traj, pred_projected_traj = None, None

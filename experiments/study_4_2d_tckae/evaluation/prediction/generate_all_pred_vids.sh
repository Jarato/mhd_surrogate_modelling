...
INPUT_NPZ="/cephfs/users/skowronek/Documents/PhD/nuclear_fusion_cooling/prediction/mhd_surrogate_modelling/experiments/study_4_2d_tckae/output/no_grad_clipping/ld512_M8_K8_Ktc8_gtc1.0_bwd_False/eval/predicted_timeseries.npz"
...
for i in "${!channels[@]}"; do
    ...
    output_filename="pred_vid_${alias}.mp4"
